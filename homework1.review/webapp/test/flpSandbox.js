		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ui5C14homework1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5C14homework1review-display": {
								"semanticObject": "ui5C14homework1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.C14.homework1.review",
									"url": sap.ui.require.toUrl("ui5/C14/homework1/review")
								}
							}
						}
					}
