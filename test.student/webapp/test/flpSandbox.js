		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생정보 관리 프로그램",
									"targetURL": "#syncc14teststudent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14teststudent-display": {
								"semanticObject": "syncc14teststudent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.test.student",
									"url": sap.ui.require.toUrl("sync/c14/test/student")
								}
							}
						}
					}
