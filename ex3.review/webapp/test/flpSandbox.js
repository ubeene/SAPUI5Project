		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습문제 3번 리뷰",
									"targetURL": "#syncc14ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14ex3review-display": {
								"semanticObject": "syncc14ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.ex3.review",
									"url": sap.ui.require.toUrl("sync/c14/ex3/review")
								}
							}
						}
					}
