		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc14testuitable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14testuitable-display": {
								"semanticObject": "syncc14testuitable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.test.ui.table",
									"url": sap.ui.require.toUrl("sync/c14/test/ui/table")
								}
							}
						}
					}
