		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습문제 1번 리뷰",
									"targetURL": "#syncc14ex1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14ex1review-display": {
								"semanticObject": "syncc14ex1review",
								"action": "display",
								"description": "230918 실습문제 리뷰",
								"title": "실습문제 1번 리뷰",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.ex1.review",
									"url": sap.ui.require.toUrl("sync/c14/ex1/review")
								}
							}
						}
					}
