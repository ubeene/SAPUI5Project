		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncux400exercise11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncux400exercise11-display": {
								"semanticObject": "syncux400exercise11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ux400.exercise11",
									"url": sap.ui.require.toUrl("sync/ux400/exercise11")
								}
							}
						}
					}
