		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Aggregation Binding",
									"targetURL": "#syncux400exercise10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncux400exercise10-display": {
								"semanticObject": "syncux400exercise10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ux400.exercise10",
									"url": sap.ui.require.toUrl("sync/ux400/exercise10")
								}
							}
						}
					}
