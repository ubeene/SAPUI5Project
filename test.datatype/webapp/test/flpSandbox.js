		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#synctestdatatype-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synctestdatatype-display": {
								"semanticObject": "synctestdatatype",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.test.datatype",
									"url": sap.ui.require.toUrl("sync/test/datatype")
								}
							}
						}
					}
