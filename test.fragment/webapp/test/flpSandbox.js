		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment 연습",
									"targetURL": "#syncc14testfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14testfragment-display": {
								"semanticObject": "syncc14testfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.test.fragment",
									"url": sap.ui.require.toUrl("sync/c14/test/fragment")
								}
							}
						}
					}
