		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create an SAPUI5 Component",
									"targetURL": "#syncux400exercise17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncux400exercise17-display": {
								"semanticObject": "syncux400exercise17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ux400.exercise17",
									"url": sap.ui.require.toUrl("sync/ux400/exercise17")
								}
							}
						}
					}
