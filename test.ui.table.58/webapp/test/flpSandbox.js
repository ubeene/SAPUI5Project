		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc14testuitable58-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14testuitable58-display": {
								"semanticObject": "syncc14testuitable58",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.test.ui.table.58",
									"url": sap.ui.require.toUrl("sync/c14/test/ui/table/58")
								}
							}
						}
					}
