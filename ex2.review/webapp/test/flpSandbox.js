		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습과제 2번 리뷰",
									"targetURL": "#syncc14ex2review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14ex2review-display": {
								"semanticObject": "syncc14ex2review",
								"action": "display",
								"description": "230918 실습과제 2번 리뷰",
								"title": "실습과제 2번 리뷰",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.ex2.review",
									"url": sap.ui.require.toUrl("sync/c14/ex2/review")
								}
							}
						}
					}
