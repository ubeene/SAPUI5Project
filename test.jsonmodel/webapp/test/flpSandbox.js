		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연습",
									"targetURL": "#syncc14testjsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14testjsonmodel-display": {
								"semanticObject": "syncc14testjsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.test.jsonmodel",
									"url": sap.ui.require.toUrl("sync/c14/test/jsonmodel")
								}
							}
						}
					}
