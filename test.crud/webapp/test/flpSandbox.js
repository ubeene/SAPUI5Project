		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공사 관리",
									"targetURL": "#syncc14testcrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc14testcrud-display": {
								"semanticObject": "syncc14testcrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c14.test.crud",
									"url": sap.ui.require.toUrl("sync/c14/test/crud")
								}
							}
						}
					}
